    ...
    def main():
        ...
        while running:
            ...
            clicker_button: Button = Button(
                (
                    adapt_size_width(705, w),
                    adapt_size_height(304, h),
                    adapt_size_width(403, w),
                    adapt_size_height(400, h),
                ),
                (w, h),
            ...
            temporal_matrix_image: pg.surface = load_image(
                f"{src_dir}/img/temporal matrix.png", w, h
            )
            screen.blit(
            ...
            # draw text
            screen.blit(
                timeUnits_text, (adapt_size_width(700, w), adapt_size_height(840, h))
            )
